...
import { Award, Search, Filter, ChevronDown, ChevronUp, Leaf, Building2, CheckCircle2 } from 'lucide-react';
  ...
  return (
    <div className="space-y-8 pb-16">
      ...
      <div className="space-y-4">
        {barangays.map(b => {
          const isExpanded = expandedBarangayId === b.id;
          return (
            <div
              key={b.id}
              className="bg-white rounded-3xl border border-slate-200/80 hover:border-emerald-300 transition-all shadow-2xs overflow-hidden"
            >
              <div className="p-5 flex flex-col md:flex-row md:items-center justify-between gap-4">
                ...
                <div className="flex items-center gap-6 justify-between md:justify-end">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <button
                      onClick={() => setExpandedBarangayId(isExpanded ? null : b.id)}
